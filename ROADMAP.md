...
| 2026-09-08 | Retraduction ciblée : re-vérification **sans le glossaire** dans le prompt (espace de cache dédié) — avec lui, le vérificateur constatait la conformité et notait 100 sans juger la langue ; à la fin de la passe la grille est filtrée sur les lignes retraduites (`translation:retranslated`, marqueur transitoire par langue sur `TranslationRow`) pour les relire |
