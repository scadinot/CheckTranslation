...
- **Repli des projets** : chaque projet se replie et se déplie (bouton de repli, double-clic). Les replis survivent aux reconstructions de l'arbre (filtre du bandeau, F5) ; un filtre du bandeau déplie tout le temps qu'il est posé, ses correspondances doivent se voir, sans oublier les replis ; une nouvelle solution repart dépliée.
