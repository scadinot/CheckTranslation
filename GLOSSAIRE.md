...
1. **Constitution** — l'extraction IA (« Extraire les termes métier… ») alimente des propositions,
...
| 2. Éditeur multi-langues | `GlossaryForm` en grille terme × langue, colonne statut | À faire |
